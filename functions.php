...
// Setup Theme
add_action( 'after_setup_theme', 'lpbcolor_setup' );
function lpbcolor_setup(): void {
	 ...
	 */
	load_theme_textdomain( 'lpbcolor', get_parent_theme_file_path( '/languages' ) );
    ...
    register_nav_menus(
        array(
            'primary'   => esc_html__('Primary Menu', 'lpbcolor'),
        )
    );
