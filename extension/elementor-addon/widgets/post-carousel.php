...
class lpbcolor_Elementor_Post_Carousel extends Widget_Base {
    ...
    public function get_name(): string {
        return 'lpbcolor-post-carousel';
    }

    public function get_title(): string {
        return esc_html__( 'Posts Carousel', 'lpbcolor' );
    }
