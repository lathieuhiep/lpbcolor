...
class lpbcolor_recent_post_widget extends WP_Widget {
	/* Widget setup */
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'recent-post-widget',
			'description' => esc_html__( 'A widget show post', 'lpbcolor' ),
		);
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_html__('Recent Post', 'lpbcolor'),
			'order' => 'DESC'
		);
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>">
				<?php esc_attr_e( 'Select Categories:', 'lpbcolor' ); ?>
            </label>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>"
                ...
                <option value="0" <?php echo( in_array( 0, $select_cat ) ? 'selected="selected"' : '' ); ?>>
					<?php esc_html_e( 'All Category', 'lpbcolor' ); ?>
                </option>
        ...
        <p>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'order_by' ) ); ?>"
                ...
                <option value="ID" <?php echo ( $order_by == 'ID' ) ? 'selected' : ''; ?>>
					<?php esc_html_e( 'ID', 'lpbcolor' ); ?>
                </option>

                <option value="date" <?php echo ( $order_by == 'date' ) ? 'selected' : ''; ?>>
					<?php esc_html_e( 'Date', 'lpbcolor' ); ?>
                </option>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
				<?php esc_html_e( 'Number of posts to show:', 'lpbcolor' ); ?>
            </label>
...
// Register widget
function lpbcolor_recent_post_widget_register() {
	register_widget( 'lpbcolor_recent_post_widget' );
}

add_action( 'widgets_init', 'lpbcolor_recent_post_widget_register' );