<?php
$sticky_menu = lpbcolor_get_option( 'opt_menu_sticky', '1' );
$logo = lpbcolor_get_option( 'opt_general_logo' );
$cart = lpbcolor_get_option( 'opt_menu_cart', '1' );
?>
<header class="global-header <?php echo esc_attr( $sticky_menu == '1' ? 'active-sticky-nav' : '' ); ?>">
    <nav class="site-navigation container">
        <div class="site-navigation__logo d-flex align-items-center">
                ...
                <ul class="main-menu">
                    <li>
                        <a href="<?php echo get_admin_url() . '/nav-menus.php'; ?>">
							<?php esc_html_e( 'ADD TO MENU', 'lpbcolor' ); ?>
                        </a>
                    </li>
                </ul>
			<?php endif; ?>
