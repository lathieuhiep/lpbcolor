...
function lpbcolor_register_required_plugins(): void
{
	 ...
	 */
	$lpbcolor_config = array(
		'id'           => 'lpbcolor',          // Unique ID for hashing notices for multiple instances of TGMPA.
	...
	tgmpa( $lpbcolor_plugins, $lpbcolor_config );
}
