<?php
$sidebar = lpbcolor_get_option('opt_post_cat_sidebar_position', 'right');
$per_row = lpbcolor_get_option('opt_post_cat_per_row', '2');

$class_col_content = lpbcolor_col_use_sidebar($sidebar, 'sidebar-main');
                                ...
                                <div class="item__content">
                                    ...
                                    <div class="post-desc">
                                        ...
                                        <a href="<?php the_permalink(); ?>" class="text-read-more">
							                <?php esc_html_e('Read more', 'lpbcolor'); ?>
                                        </a>

						                <?php lpbcolor_link_page(); ?>
                                    </div>
                                </div>
                            </div>
		                <?php
